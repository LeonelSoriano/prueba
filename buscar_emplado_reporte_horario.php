...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        while($test = mysql_fetch_array($result))
        {
            ...
            echo '<td> <ul onClick="devolver(\''.$id.'\',\''.$primernombre .' '. $primerapellido  .'\',\''.$cedula.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
...
<script>
    function devolver(id,nombre,placa){
        ...
        opener.document.formulario.nombre_empleado.value = nombre;
        opener.document.formulario.codigo_empleado_hi.value = id;
        opener.document.formulario.cedula_empleado.value = placa;
