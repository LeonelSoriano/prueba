    ...
    <form method="post">
        ...
        <table border=none class="tablas-nuevas">
            <tr>
                ...
                <th>Nombre de Material / Servicio</th>
                <th>Fecha de inicio</th>
                <th>Producción Plnificada</th>
...
prc_orden_trabajo.produccion_planificada as planificada,
prc_orden_trabajo.fecha_inicio as fecha_inicio,
min_productos_servicios.nombre as nombre_producto,
prc_orden_trabajo.codigo_alias as nombre_orden
FROM prc_orden_trabajo
inner join min_productos_servicios
ON min_productos_servicios.codigo = prc_orden_trabajo.codigo_producto
WHERE eliminada = 'n' AND fecha_culminacion='n'
";
            ...
            while($test = mysql_fetch_array($result))
            {
                ...
                $nombre_producto = $test['nombre_producto'];
                $fecha_inicio = $test['fecha_inicio'];
                $planificada = $test['planificada'];
                ...
                echo"<td><font color='black'>".  $planificada .  "</font></td>";

                echo '<td> <ul onClick="devolver(\''.$id.'\',\''.$nombre_orden.'\',\''.$nombre_producto.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
    ...
    <script>
        function devolver(id,nombre,nombre_material){

            opener.document.formulario.nombre_orden.value = nombre;
            opener.document.formulario.nombre_orden_hi.value = id;
