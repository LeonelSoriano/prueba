...
mrh_empleado.primernombre as primer_nombre,
mrh_empleado.primerapellido as primer_apellido,
mrh_cargo.descripcion as nombre_cargo
FROM mrh_empleado
left join mrh_cargo
ON mrh_empleado.codigo = mrh_cargo.codigo
WHERE retirado = 'no' ORDER BY cedula * 1
";
            ...
            while($test = mysql_fetch_array($result))
            {
                ...
                $id = $test['codigo'];
                $cedula = $test['cedula'];
                $primer_nombre = $test['primer_nombre'];
                $primer_apellido = $test['primer_apellido'];
                $nombre_cargo = $test['nombre_cargo'];

                echo "<tr align='center'>";

                echo"<td><font color='black'>". $cedula .  "</font></td>";
                echo"<td><font color='black'>". $primer_nombre . "</font></td>";
                echo"<td><font color='black'>". $primer_apellido . "</font></td>";
    ...
    <script>
        function devolver(id,nombre){
            ...
            opener.document.formulario.cedula_trabajador.value = nombre;
            opener.document.formulario.codigo_trabajador_hi.value = id;
