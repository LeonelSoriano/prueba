...
prc_orden_trabajo_etapas.codigo as codigo,
mno_gerencia.descripcion as etapa
 FROM prc_orden_trabajo_etapas
inner join mno_gerencia
on prc_orden_trabajo_etapas.codigo_departamento = mno_gerencia.codigo
WHERE
prc_orden_trabajo_etapas.codigo_orden_trabajo = '$orden'");
            ...
            while($test = mysql_fetch_array($result))
            {
                ...
                echo '<td > <ul onClick="devolvercedula(\''.$id.'\',\''.$etapa.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
    ...
    <script>
        function devolvercedula(id,etapa){

            opener.document.formulario.etapa_campo.value = etapa;
            opener.document.formulario.codigo_etapa_hi.value = id;
