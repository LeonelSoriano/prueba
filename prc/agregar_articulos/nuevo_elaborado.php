...
if (isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO min_productos_servicios(codigo_alias,nombre,existencia_minima,existencia_maxima,fecha_vencimiento,fecha_adquisicion,ubicacion,observacion,mco_unidad,inventario,foto_articulo) VALUES
        ...
        '$fecha_vencimiento','$fecha_adquisicion','$ubicacion','$observacion','$unidad_medida_tmp','6',
        '$imagen');";
...
<div id="">
    <div id="firefoxbug"><!-- firefoxbug -->
        ...
        <div class="dynamicContent" align="left">
            ...
            <h1><img src="../../images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong> Módulo de Producción | Nuevo Producto Terminado</strong></h1>
