...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        <?php
        include("../../db.php");
        $result=mysql_query("SELECT * FROM min_productos_servicios WHERE inventario=6 OR inventario=4 ORDER BY nombre ");
        while($test = mysql_fetch_array($result))
        {
            ...
            echo"<td style='text-align: left'><font color='black'>" .$proveedor ."</font></td>";

            echo"<td style='text-align: left'><font color='black'>". $ubicacion . "</font></td>";
            echo"<td style='text-align: right'><font color='black'>". $existencia.  "</font></td>";
            echo '<td> <ul onClick="devolvercedula(\''.$codigo_alias.'\',\''.$id.'\',\''.$nombre.'\',\''.$nombre_inventario.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
...
<script>
    function devolvercedula(codigo_alias,id,nombre_articulo,nombre_inventario){
        ...
        //opener.document.semielaborados.nombre_articulo.value =  "lenel" ;

        opener.document.semielaborados.articulo.value = nombre_articulo;
        opener.document.semielaborados.codigo_articulo.value = codigo_alias;
        opener.document.semielaborados.inventario_nombre.value = nombre_inventario;
        opener.document.semielaborados.codigo.value = id;
