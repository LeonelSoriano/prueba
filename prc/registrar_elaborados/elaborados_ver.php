...
WHERE
	...
	AND min_productos_servicios.inventario = '6'
	");
                                    ...
                                    while($test = mysql_fetch_array($result)){
                                        ...
                                        echo"<td><font color='black'>". $nombre_codigo . "</font></td>";
...
//                                        echo"<td><font color='black'>". $test['correo']. "</font></td>";
                                        ...
                                        echo"<td> <a href ='elaborados_del.php?codigo=$id'>Eliminar</a></td>";
                                        echo "</tr>";
                                    }
                                    mysql_close($conn);
                                    ?>
                            ...
                            <br/>
                            <a href="elaborados.php"><input type="button" value="Atras"></a>
                            <p></p>
                        </div>
                    </div><!--end firefoxbug-->
                </div><!--end left_bgd-->
