...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        $result=mysql_query("SELECT * FROM mno_gerencia WHERE etapa = 'si' ORDER BY descripcion ");
...
<script>
    function devolvercedula(codigo_alias,id,nombre){
        ...
        opener.document.registrar.nombre_etapa.value = nombre;
        opener.document.registrar.codigo_departamento_hi.value = id;
