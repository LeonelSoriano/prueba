...
//
//        $sql = "INSERT INTO prc_semielaborados(codigo_producto,cantidad) VALUES ('$id','$uso')";
//
...
//                        "<td style='display: none'> <label style='font-size: 14px'>" + codigo + "</label> </td> " +
                ...
                <div id="">
                    <div id="firefoxbug"><!-- firefoxbug -->
                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <h1><img src="../../images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Producción | Agregar Capacidad Semi-Elaborado</strong></h1>
                            <br/>
...
<!--                                </tr>-->
                                ...
                                <input name="inventario_nombre" type="hidden" value="" id="inventario_nombre" name="inventario_nombre"/>
...
<!--                                <input type="hidden" value="" id="post_array" name="post_array"/>-->
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><a href="semielaborados_ver.php"><input type="button" value="Ver datos"></a> </td>
