...
//                    $(".fecha").show(500);
//                    $(".orden").show(500);
//                }else if($(this).val() == 'estandar'){
//                    $(".fecha").hide(500);
//                    $(".orden").hide(500);
//
//                }else if($(this).val() == 'variacion'){
//                    $(".fecha").show(500);
//                    $(".orden").show(500);
//                }
//            });
...
<form method="post" accept-charset="UTF-8" name="formulario" action="./reporte_tarjeta_estandar.php">
                ...
                <div id="">
                    <div id="firefoxbug"><!-- firefoxbug -->
                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <h1><img src="../../images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Producción | Reporte Tarjeta Estandar</strong></h1>
                            <br/>
                            <TABLE BORDER="0" CELLSPACING="10" >
                                ...
                                <!--                                    <td>-->
                                <!--                                        <input type="radio" name="tipo" value="estandar" > &nbsp;Estandar<br><br/>-->
                                <!--                                        <input type="radio" name="tipo" value="real" checked> &nbsp;Real <br/><br/>-->
                                <!--                                        <input type="radio" name="tipo" value="variacion"> &nbsp;Variación-->
                                <!--                                    </td>-->
                                <!---->
                                <!--                                </tr>-->
                                <!---->
                                ...
                                <input type="hidden" name="tipo" value="tarjeta_estandar"/>
