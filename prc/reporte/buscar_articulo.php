...
WHERE
	min_productos_servicios.eliminado = 'no'";
            ...
            while($test = mysql_fetch_array($result))
            {
                ...
                echo"<td style='text-align: left'><font color='black'>". $nombre_bien .  "</font></td>";
                echo"<td style='text-align: left'><font color='black'>". $inventario . "</font></td>";
                echo"<td style='text-align: left'><font color='black'>". $unidad . "</font></td>";

                echo '<td> <ul onClick="devolver(\''.$id.'\',\''.$nombre_bien.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
    ...
    <script>
        function devolver(id,nombre){
            ...
            opener.document.formulario.acticulo.value = nombre;
            opener.document.formulario.codigo_articulo_hi.value = id;
