...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        while($test = mysql_fetch_array($result))
        {
            ...
            echo '<td> <ul onClick="devolvercedula(\''.$codigo_alias.'\',\''.$id.'\',\''.$nombre.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
...
<script>
    function devolvercedula(codigo_alias,id,nombre){
        ...
        opener.document.detalle_erogacion.departamento_nombre.value = nombre;
        opener.document.detalle_erogacion.codigo_departamento_hi.value = id;
