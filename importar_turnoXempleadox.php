...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], 'import_'. $target_file)) {
            ...
            include_once('importar_turnoXempleado_exxel.php');
                ...
                <div id="">
                    <div id="firefoxbug"><!-- firefoxbug -->
                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <h1><img src="./images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Recursos Humanos | Importar Turnos por Empleado</strong></h1>
                            <br/>
                            <?php
