...
<form method="post">
    ...
    <h1><img src="images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Recursos Humanos | Departamento</strong></h1>
...
<table>
        ...
        <td><a href="departamento_ver.php"><input type="button" value="Ver datos"></a> </td>
...
if (isset($_POST['submit']))
	...
	include 'db.php';
        ...
        $sql = "insert into mrh_departamento(codigoalias,descripcion)
