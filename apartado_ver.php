...
<table border=1>
    ...
    <?php
	include("db.php");
	$result=mysql_query("SELECT * FROM mno_apartado");
        while($test = mysql_fetch_array($result))
        	{
                //  calculos de horas
                    ...
                    echo"<td><font color='black'>". $test['dias']."</font></td>";
                    echo"<td><font color='black'>". $test['fechavigencia']."</font></td>";
                    echo"<td> <a href ='apartado_mod.php?codigo=$id'>Modificar</a>";
                    echo"<td> <a href ='apartado_del.php?codigo=$id'><center>Borrar</center></a>";
                    echo "</tr>";
		}
	mysql_close($conn);
    ?>
...
<table>    
    <tr>
        <a href="apartado.php"><input type="button" value="Atras"></a>
    </tr> 
</table>
<p></p>
                                </div>
