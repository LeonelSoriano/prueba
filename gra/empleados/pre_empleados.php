...
<form method="post" accept-charset="UTF-8" name="formulario" action="empleados.php">
                ...
                <div id="">
                    <div id="firefoxbug"><!-- firefoxbug -->
                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <h1><img src="../../images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Gráficos | Grafico de Empleados</strong></h1>
                            <br/>
                            ...
                            <TABLE BORDER="0" CELLSPACING="10" >
                                ...
                                <tr>
                                    <td>
                                        <label for="">Filtrado</label><br/><br/>
<!--                                        <label for="">Departamento</label>  <input type="radio" name="filtrado" value="departamento" checked/><br/><br/>-->
                                        <label for="">Tipo Trabajador</label>  <input type="radio" name="filtrado" value="tipo_empleado"  checked/><br/><br/>
                                        <br/>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <label for="">Tipo de Grafíca</label><br/><br/>
