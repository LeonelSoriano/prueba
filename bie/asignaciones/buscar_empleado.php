...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        <?php
        include("../../db.php");
        $sql ="SELECT * FROM mrh_empleado ORDER BY cedula";
...
<script>
    function devolvercedula(id,cedula){
        ...
        opener.document.asignacion.nombre_empleado.value = cedula;
        opener.document.asignacion.codigo_empleado_hi.value = id;
