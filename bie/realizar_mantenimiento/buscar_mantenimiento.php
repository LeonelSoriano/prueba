...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        $sql ="SELECT
bie_mantenimiento.codigo as codigo,
bie_mantenimiento.nombre as nombre,
bie_unidad_medida.nombre as nombre_unidad
FROM bie_mantenimiento
INNER JOIN bie_unidad_medida
ON bie_unidad_medida.codigo = bie_mantenimiento.codigo_tipo_medida
WHERE bie_mantenimiento.eliminado = 'n' AND bie_mantenimiento.codigo_tipo_bien = '$id'";
...
<script>
    function devolver(id,nombre){
        ...
        opener.document.formulario.nombre_mantenimiento.value = nombre;
        opener.document.formulario.codigo_mantenimiento_hi.value = id;
