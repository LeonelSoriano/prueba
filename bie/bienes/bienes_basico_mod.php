...
print_r($_POST);
    ...
    if(!$validated->getIsError()){
        ...
        $sql = "UPDATE bie_tipo_basico SET nombre_bien = '$nombre_bien', codigo_alias = '$codigo_alias',
         codigo_contable = '$codigo_contable', codigo_departamento = '$departamento_hi', vida_util = '$vida_util',
          ...
          valor_actualizado = '$valor_actualizado', codigo_depreciacion = '$metodo_depreciacion' WHERE codigo = '$codigo_bien'";


        mysql_query($sql) or die('No se pudo guardar la información. '.mysql_error());

        header("Location: ./bienes_basico_mod.php?id=".$codigo_bien."&error=false");

        //send_error_redirect(false);
    }else{
        header("Location: ./bienes_basico_mod.php?id=".$codigo_bien."&error=true");
    }
...
if(isset($_GET['id'])){
    ...
    $sql = "SELECT bie_tipo_basico.nombre_bien as nombre_bien, bie_tipo_basico.codigo_alias codigo_alias,
    bie_tipo_basico.codigo_contable as codigo_contable, mno_gerencia.descripcion as nombre_departamento,
    bie_tipo_basico.codigo_departamento as codigo_departamento, bie_tipo_basico.vida_util as vida_util,
    bie_tipo_basico.fecha_adquisicion as fecha_adquisicion, bie_tipo_basico.costo_adquisicion as costo_adquisicion,
    bie_tipo_basico.valor_rescate as valor_rescate,  bie_tipo_basico.codigo_depreciacion as codigo_depreciacion,
    bie_tipo_basico.valor_mercado as valor_mercado, bie_tipo_basico.valor_actualizado as valor_actualizado
        FROM bie_tipo_basico
        JOIN mno_gerencia
         ON bie_tipo_basico.codigo_departamento = mno_gerencia.codigo
         WHERE bie_tipo_basico.codigo ='$id'";
    ...
    <div id="firefoxbug"><!-- firefoxbug -->
        ...
        <div class="dynamicContent" align="left">
            ...
            <TABLE BORDER="0" CELLSPACING="4" WIDTH="500">
                ...
                <input type='hidden' name='codigo_tipo' value='1'/>
