...
if (isset($_POST['submit'])){
    ...
    if(!$validated->getIsError()){
        ...
        $mts_edificacion = $_POST['mts_edificacion'];

        $codigo_bien = $_POST['codigo_bien'];


        $sql = "UPDATE bie_tipo_activo_principal SET nombre_bien = '$nombre_bien', codigo_alias = '$codigo_alias',
         codigo_contable = '$codigo_contable',  vida_util = '$vida_util',
          ...
          valor_actualizado = '$valor_actualizado', mts_edificacion = '$mts_edificacion',codigo_depreciacion = '$metodo_depreciacion'
           WHERE codigo = '$codigo_bien'";


        mysql_query($sql) or die('No se pudo guardar la información. '.mysql_error());

        header("Location: ./activo_principal_mod?id=".$codigo_bien."&error=false");

        //send_error_redirect(false);
    }else{
        header("Location: ./activo_principal_mod?id=".$codigo_bien."&error=true");
    }
...
if(isset($_GET['id'])){
    ...
    $sql = "SELECT bie_tipo_activo_principal.nombre_bien as nombre_bien, bie_tipo_activo_principal.codigo_alias codigo_alias,
    bie_tipo_activo_principal.codigo_contable as codigo_contable,
     bie_tipo_activo_principal.vida_util as vida_util,
    bie_tipo_activo_principal.fecha_adquisicion as fecha_adquisicion, bie_tipo_activo_principal.costo_adquisicion as costo_adquisicion,
    bie_tipo_activo_principal.valor_rescate as valor_rescate,  bie_tipo_activo_principal.codigo_depreciacion as codigo_depreciacion,
    bie_tipo_activo_principal.valor_mercado as valor_mercado, bie_tipo_activo_principal.valor_actualizado as valor_actualizado,
    bie_tipo_activo_principal.mts_edificacion as mts_edificacion
        FROM bie_tipo_activo_principal
         WHERE bie_tipo_activo_principal.codigo ='$id'";

    $result=mysql_query($sql);

    $test = mysql_fetch_array($result)or die('bie_tipo_basico'.mysql_error());
                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <TABLE BORDER="0" CELLSPACING="4" WIDTH="500">
                                ...
                                <tr>
                                    ...
                                    <td><input type='text' name='mts_edificacion' value="<?php echo($mts_edificacion); ?>"/></td>
                                </tr>
                                ...
                                <input type='hidden' name='codigo_tipo' value='4'/>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <a href="./agregar_departamento_activo_principal.php?id=<?php echo($_GET['id']) ?>"><input type="button" value="Modificar Metros/Departamentos"></a>
                                    </td>
                                    <td>
