...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        $sql ="
SELECT
bie_tipo_vehiculo.codigo as codigo,
bie_tipo_vehiculo.nombre_bien as nombre,
bie_tipo_vehiculo.modelo_vehculo as modelo,
bie_tipo_vehiculo.placa_vehculo as placa,
bie_tipo_vehiculo.kilometros as kilometros,
mno_gerencia.descripcion as nombre_departamento
FROM bie_tipo_vehiculo
INNER JOIN mno_gerencia
ON mno_gerencia.codigo = bie_tipo_vehiculo.codigo_departamento
...
";
        ...
        while($test = mysql_fetch_array($result))
        {
            ...
            echo"<td><font color='black'>". $modelo_vehiculo . "</font></td>";
            ...
            echo '<td> <ul onClick="devolver(\''.$id.'\',\''.$nombre.'\',\''.$placa.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
...
<script>
    function devolver(id,nombre,placa){

        opener.document.formulario.nombre_vehiculo.value = nombre;
