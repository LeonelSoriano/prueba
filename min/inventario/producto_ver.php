...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        $result=mysql_query("SELECT * FROM db_sicap.min_productos_servicios
...
AND (min_valoracion.unidades <>  '0'
AND min_valoracion.costo_total <> '0'
AND min_valoracion.promedio_actual <> '0'
)
");
        while($test = mysql_fetch_array($result))
        {
            ...
            echo"<td style='text-align: right'><font color='black'>". utf8_multiplataforma($unidades) .  "</font></td>";
            echo"<td style='text-align: right'><font color='black'>".formatear_ve($promedio_actual) .  "</font></td>";
...
<script>
    function devolverdatos(codigo_alias,id,existencia,precio){
        ...
        if(existencia > 0){
            ...
            opener.document.uso_consumo.producto.value = codigo_alias;
            opener.document.uso_consumo.codigo_producto_hi.value = id;
