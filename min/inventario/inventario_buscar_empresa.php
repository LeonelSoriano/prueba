...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        <?php
        include("../../db.php");
        $result=mysql_query("SELECT * FROM min_empresa order by codigo_alias");
        while($test = mysql_fetch_array($result))
        {
            ...
            echo"<td><font color='black'>". $rif . "</font></td>";
            echo"<td><font color='black'>". $descripcion . "</font></td>";
            echo"<td><font color='black'>". $correo . "</font></td>";
            echo"<td><font color='black'>". $direccion.  "</font></td>";
            echo"<td><font color='black'>". $telefono .  "</font></td>";
            echo '<td> <ul onClick="devolverdatos(\''.$codigo_alias.'\',\''.$id.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
            echo "</tr>";
        }
        mysql_close($conn);
        ?>
...
<script>
    function devolverdatos(codigo_alias, id){
        var _codigo = codigo_alias;

        opener.document.inventario.empresa.value = _codigo;
        opener.document.inventario.codigo_empresa.value = id;
