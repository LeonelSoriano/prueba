...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        $result=mysql_query("SELECT prc_etapas.codigo as codigo_etapa, mno_gerencia.codigo as codigo,mno_gerencia.descripcion as r FROM prc_etapas
...
WHERE prc_etapas.codigo_producto='$id'  ORDER BY mno_gerencia.descripcion;");
        ...
        while($test = mysql_fetch_array($result))
        {
           ...
           // echo"<td><font color='black'>" .$produccion_planificada."</font></td>";
            ...
            echo '<td> <ul onClick="devolverdatos(\''.$etapa.'\',\''.$id.'\',\''.$codigo_etapa.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
