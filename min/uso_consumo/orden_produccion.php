...
<form method="post">
    ...
    DISTINCT(prc_etapas.codigo_producto) as codigo,
...
FROM
    ...
    min_productos_servicios ON min_productos_servicios.codigo = prc_etapas.codigo_producto");
        ...
        while($test = mysql_fetch_array($result))
        {
            ...
            echo"<td><font color='black'>" .utf8_multiplataforma($nombre_producto)."</font></td>";

            echo '<td> <ul onClick="devolverdatos(\''.utf8_multiplataforma($nombre_producto).'\',\''.$id.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
