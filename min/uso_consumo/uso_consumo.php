...
//                                  existencia_final,fecha_uso,codigo_etapa,costo_articulo)
...
//                                '$fecha_actual','$codigo_etapa','$promedio_actual')";
//
//        mysql_query($sql) or die('No se pudo guardar la información. ' . mysql_error());
        ...
        $sql = "SELECT codigo_depende FROM mno_gerencia WHERE codigo = $codigo_etapa";
        ...
        if (!$result) {
            die("Error: Data not found.. codigodepende mno_geencia");
        }
        ...
        $sql = "SELECT COUNT(*) as total FROM min_valoracion_produccion WHERE codigo_producto='$codigo_articulo'
AND codigo_departamento = '$codigo_depende'";
        ...
        if (!$result) {
            die("Error: Data not found.. min_valoracion_produccion");
        }

        $count_valoracion_produccion = $test['total'];
        ...
        $sql = "    INSERT INTO min_valoracion_produccion_historico
                ...
                '$codigo_depende',
                '$cantidad_despacho',
                '".($promedio_actual*$cantidad_despacho)."',
                '$promedio_actual',
                '$fecha_actual'
                );";


        mysql_query($sql) or die('No se pudo guardar la información min_valoracion_produccion_historico. '.mysql_error());



        if($count_valoracion_produccion == '0'){

            $sql = "INSERT INTO min_valoracion_produccion
                (
                codigo_producto,
                codigo_departamento,
                unidades,
            ...
            mysql_query($sql) or die('No se pudo guardar la información min_valoracion_produccion. '.mysql_error());
...
//            $promedio_actual = $test['promedio_actual'];
            ...
            $nuevas_unidades = $unidades + $cantidad_despacho;
            $nuevo_costo = $costo_total + ($promedio_actual*$cantidad_despacho) ;


            $nuevo_promedio = 0;
            if($nuevas_unidades != 0){
            $nuevo_promedio =  $nuevo_costo/ $nuevas_unidades;
            }
            ...
            $sql = "UPDATE min_valoracion_produccion SET
                    ...
                    codigo_departamento = '$codigo_depende',
                    unidades = '$nuevas_unidades',
                    costo_total = '$nuevo_costo',
                    promedio_actual = '$nuevo_promedio'
                WHERE codigo_producto ='$codigo_articulo' AND codigo_departamento = '$codigo_depende'";
...
";
        ...
        $sql = "INSERT INTO min_requisicion_etapa
                (
                codigo_producto,
                valoracion,
                costo,
...
<head>
    ...
    <meta name="author" content="Leonel Soriano leonelsoriano@hotmail.com" />
        ...
        $(function() {
            ...
            $("#agregar").click(function() {
                ...
                if($("#codigo_articulo").val() != '' ){
                    ...
                    "<td  style='text-align: right'> <label style='font-size: 14px'>"+((Math.round(precio*100)/100).toString()).replace('.',',')+"</label> </td> " +
                    "<td  style='text-align: right'> <label style='font-size: 14px'>"+ ((Math.round(cantidad_despacho*100)/100).toString()).replace('.',',')+"</label> </td> " +
                    "<td  style='text-align: right'> <label style='font-size: 14px'>"+ ((Math.round((cantidad_despacho*precio)*100)/100).toString()).replace('.',',')+"</label> </td> " +
            ...
            $( "#buscar_articulo" ).click(function() {
                ...
                var id = $("#codigo_solicitante").val();
                var id_etapa = $("#codigo_etapa_hi").val();
                    ...
                    <div id="firefoxbug"><!-- firefoxbug -->
                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <TABLE BORDER="0" CELLSPACING="4" WIDTH="500" id="tabla_articulos">
                                ...
                                <input type="hidden" value="" id="codigo_etapa_hi" name="codigo_etapa_hi"/>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <a href="uso_consumo_ver.php?paso=0"><input type="button" value="Ver datos"></a>
                                    </td>
                                    <td>
