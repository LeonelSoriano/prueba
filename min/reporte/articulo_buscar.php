...
WHERE
    min_productos_servicios.inventario = '$codigo_inventario'
ORDER BY nombre";
...
//
            opener.document.formulario.nombre_producto.value = nombre;
            opener.document.formulario.id_producto.value = id;
