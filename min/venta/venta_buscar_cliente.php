...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        <tr>
            ...
            echo '<td> <ul onClick="devolvercedula(\''. $test['codigo_alias'].'\',\''.$id.'\',\''.$test['rif'].'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
...
<script>
    function devolvercedula(codigo_alias,id,rif){


        opener.document.venta.nombre_cliente.value =  codigo_alias ;
        opener.document.venta.codigo_cliente.value =  id ;
        opener.document.venta.rif_cliente.value =  rif ;
