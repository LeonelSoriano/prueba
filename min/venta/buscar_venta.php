...
SELECT
    ...
    min_cliente.codigo_alias as cliente,
    min_ventas.fecha_venta as fecha,
    min_ventas.codigo as codigo,
    min_ventas.cantidad as cantidad,
    min_ventas.costo_unidad as unidad,
    min_ventas.cantidad * min_ventas.costo_unidad as total
FROM
    min_ventas
        INNER JOIN
    min_productos_servicios ON min_productos_servicios.codigo = min_ventas.codigo_articulo
        INNER JOIN
    mrh_empleado ON mrh_empleado.codigo = min_ventas.codigo_empleado
        INNER JOIN
    min_cliente ON min_cliente.codigo = min_ventas.codigo_cliente
WHERE
    min_ventas.venta_credito = 'si'
        AND min_ventas.cobrado = 'no'
";
            ...
            while($test = mysql_fetch_array($result))
            {
                ...
                echo"<td><font color='black'>". $cliente . "</font></td>";
                echo"<td><font color='black'>". $placa . "</font></td>";
                echo"<td><font color='black'>".  $fecha .  "</font></td>";
                echo"<td><font color='black'>".  $cantidad .  "</font></td>";
                echo"<td><font color='black'>".  $unidad .  "</font></td>";
    ...
    <script>
        function devolver(id,nombre){
            ...
            opener.document.formulario.nombre_venta.value = nombre;
            opener.document.formulario.codigo_venta_hi.value = id;
