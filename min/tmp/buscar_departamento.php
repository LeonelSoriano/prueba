...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        <?php
        include("../../db.php");
        $result=mysql_query("SELECT * FROM mno_gerencia order by descripcion");
        while($test = mysql_fetch_array($result))
        {
            ...
            echo '<td> <ul onClick="devolverdatos(\''.$descripcion.'\',\''.$id.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
            echo "</tr>";
        }
        mysql_close($conn);
        ?>
...
<script>
    function devolverdatos(descripcion,id){


        opener.document.uso_consumo.descripcion.value = descripcion;
        opener.document.uso_consumo.descripcion_hi.value = id;
