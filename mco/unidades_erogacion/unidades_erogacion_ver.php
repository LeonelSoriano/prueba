                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <table border=none class="tablas-nuevas" id="tabla_nueva">
                                ...
                                <tr>
                                    ...
                                    $sql = "SELECT * FROM mco_unidad_erogacion WHERE eliminado='no'";
                                    ...
                                    while($test = mysql_fetch_array($result)){
                                        ...
                                        echo "<td><font color='black'>". $sigla . "</font></td>";

                                        echo"<td style='text-align: center'> <a href ='unidades_erogacion_mod.php?codigo=$id'>Modificar</a></td>";
                                        echo"<td style='text-align: center'> <a href ='unidades_erogacion_del.php?codigo=$id'>Eliminar</a></td>";
                                        echo "</tr>";
                                    }
                            ...
                            <br/><br/><br/>
                            <a href="unidades_erogacion.php"><input type="button" value="Atras"></a>
                            <p></p>
                        </div>
                    </div><!--end firefoxbug-->
                </div><!--end left_bgd-->
