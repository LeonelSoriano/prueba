...
?>
	...
	prc_orden_trabajo.codigo_alias as identificador,
...
WHERE
    fecha_culminacion <> 'n'
        ...
        AND prc_orden_trabajo.eliminada = 'n'";
            ...
            while($test = mysql_fetch_array($result))
            {
                ...
                echo"<td><font color='black'>". $identificador . "</font></td>";
                echo"<td><font color='black'>". $nombre .  "</font></td>";
                echo"<td style='text-align: right'><font color='black'>". $planificada . "</font></td>";
                echo"<td style='text-align: right'><font color='black'>". $produccion_real .  "</font></td>";

                echo '<td> <ul onClick="devolver(\''.$id.'\',\''.$identificador.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
    ...
    <script>
        function devolver(id,nombre){
            ...
            opener.document.formulario.codigo_orden_hi.value = id;
