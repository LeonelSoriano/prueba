...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        include("../../db.php");
        $sql ="
SELECT mrh_empleado.cedula as cedula,
mrh_empleado.primerapellido as primerapellido,
mrh_empleado.primernombre as primernombre,
mrh_empleado.codigo as codigo ,
mno_new_bono_variable.valor as valor
FROM mrh_empleado
LEFT JOIN mno_new_bono_variable
ON mno_new_bono_variable.codigo_empleado = mrh_empleado.codigo
WHERE mrh_empleado.retirado = 'no'
";
        ...
        while($test = mysql_fetch_array($result))
        {
            ...
            echo"<td><font color='black'>". $nombre . "  ". $apellido ."</font></td>";
            echo"<td><font color='black'>". $cedula . "</font></td>";


            echo '<td> <ul onClick="devolver(\''.$id.'\',\''.$cedula.'\',\''.$valor.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
