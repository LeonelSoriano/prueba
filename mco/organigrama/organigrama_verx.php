                            ...
                            <form method="post">
                                ...
                                <table border=none class="tablas-nuevas">
                                    ...
                                    while($test = mysql_fetch_array($result))
                                    {
                                        ...
                                        echo"<td><font color='black'>". $test['nombre_depende']."</font></td>";
                                        echo"<td> <a href ='organigrama_mod.php?codigo=$id'>Modificar</a>";
                                        echo"<td> <a href ='organigrama_del.php?codigo=$id'><center>Borrar</center></a>";
                                        echo "</tr>";
                                    }
                                    mysql_close($conn);
                                    ?>
                                ...
                                <table>
                                    <tr>
                                        <td><a href="configurar_organigrama.php"><input type="button" value="Atras"></a></td>
                                    </tr>
                                </table>
                                <p></p>
                        </div>
