...
<TABLE BORDER="0" CELLSPACING="4" WIDTH="500">
     ...
     <TD><label>Constante</label></TD>    
            ...
            // Consultar la base de datos
                include("../../db.php");
                $consulta_mysql='select * from mno_constante where asignacion="N"';
...
<table>
        ...
        <td><a href="/sicap/mco/montoconstante/montoconstante_ver.php"><input type="button" value="Ver datos"></a> </td>
