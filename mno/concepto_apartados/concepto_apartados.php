...
<!-- Beginning of compulsory code below -->
 ...
 <h1><img src="/sicap/images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Nómina | Conceptos de Apartados</strong></h1>
...
<TABLE BORDER="0" CELLSPACING="4" WIDTH="500">
    ...
    <TR>
        <TD width="107"><label>Utilidades</label></TD>
        <TD width="98"><input type="checkbox" name="bnocturno" id="bnocturno" size="20" value=<?php $bnocturno ?>></TD>
    </TR>
    <TR>
        <TD width="107"><label>Aguinaldos</label></TD>
        <TD width="98"><input type="checkbox" name="dsalario" id="dsalario" size="20"></TD>
    </TR>
    <TR>
        <TD width="107"><label>Bono Vacacional</label></TD>
        <TD width="98"><input type="checkbox" name="hed" id="hed" size="20"></TD>
    </TR>
    <TR>
        <TD width="107"><label>Bono Post Vacacional</label></TD>
        <TD width="98"><input type="checkbox" name="hen" id="hen" size="20"></TD>
    </TR>
    <TR>
        <TD width="107"><label>Vacaciones</label></TD>
        <TD width="98"><input type="checkbox" name="cticket" id="cticket" size="20"></TD>
    </TR>
     <TR>
        <TD width="107"><label>Prestaciones Sociales</label></TD>
        <TD width="98"><input type="checkbox" name="cticket" id="cticket" size="20"></TD>
    </TR>
         <TR>
        <TD width="107"><label>Intereses Prestaciones Sociales</label></TD>
        <TD width="98"><input type="checkbox" name="cticket" id="cticket" size="20"></TD>
    </TR>
...
function buscar_empleado(){
    win = window.open("concepto_apartados_buscarempleado.php", "nuevo", "directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=400, height=400");
    win.focus(); 
}
