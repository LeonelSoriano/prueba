...
<table>   
     <tr>
        ...
        <td> 
            <a href="unidadadm_ver.php?codigo=<?php echo $id?>"><input type="button" value="Ver datos"></a>
        </td>
        <TD>
            <a href="/sicap/mno/gerencia/gerencia_ver.php"><input type="button" value="Atras"></a> 
        </TD>
     </tr>
</table>
<!-- / END -->
...
if (isset($_POST['submit']))
	...
	include '../../db.php';
        ...
        $sql = "insert into mno_unidadadm(codigoalias,codigogerencia,descripcion)
                                                      values('$codigoalias','$id','$descripcion')";
	//echo $sql;
        //exit;
