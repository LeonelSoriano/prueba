...
<table>
        ...
        <td><a href="/sicap/mno/otros_ben/otros_ben_ver.php"><input type="button" value="Ver datos"></a> </td>
...
if (isset($_POST['submit']))
	{	   
            ...
            $codigoalias = "c$1AC".$codigoalias;

            $descripcion=$_POST['descripcion'];
            $asignacion = "N";

            $sql = "insert into mno_constante(codigoproceso,descripcion,asignacion)
