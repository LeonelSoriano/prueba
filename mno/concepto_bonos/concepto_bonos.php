...
if (isset($_POST['ver_turnos']))
	{	
            ...
            if ($bd_mostrar==1){
                header ("Location: concepto_bonos_ver.php?cedulaempleado=$cedulaempleado");
            }
...
function buscar_empleado(){
    win = window.open("concepto_bonos_buscarempleado.php", "nuevo", "directories=no, location=no, menubar=no, scrollbars=yes, statusbar=no, tittlebar=no, width=400, height=400");
    win.focus(); 
}
