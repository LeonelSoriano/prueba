										...
										$monto = $monto_resultado; 
											...
											while($field = mysql_fetch_array($ciclo)){
												...
												elseif ($variable=="1UA"){
														...
														$var_dias_prestaciones = $var_salario_integral*$monto * $valor;
												...
												elseif ($variable=="1UB"){
														...
														$var_interes_prestaciones = $var_dias_prestaciones*$monto * $valor;
												...
												elseif ($variable=="1VC"){
														...
														//echo $monto."//";		
												     	...
												     	$var_banavih = $var_salario_integral*$monto * $valor;
												...
												elseif ($variable=="1VD"){
												       ...
												       $var_inces = (($var_salario_normal + $var_bono_vacacional)*$monto )* $valor;
													   $sql = "update 
																	mno_concepto_empleados 
																set 
																	resultado='$var_inces'
												...
												} // Calculo de Ley de deporte
												elseif ($variable=="1VF"){
												        //echo "**".$valor."**";
														//echo $monto."//";		
														
												     	$var_deporte = $monto * $valor;
													    //echo "-".$var_deporte;
