        ...
        while($test = mysql_fetch_array($result))
        	{
                //  calculos de horas
                    ...
                    echo"<td><font color='black'>". strtoupper($test['primernombre'])." ".strtoupper($test['segundonombre']). "</font></td>";
                    echo"<td><font color='black'>". strtoupper($test['primerapellido'])." ".strtoupper($test['segundoapellido']). "</font></td>";
...
function devolvercedula(ced,nom,ape){
    ...
    opener.document.carga_laboral.cedulaempleado.value = ced;
    opener.document.carga_laboral.nombre.value = nom;
    opener.document.carga_laboral.apellido.value = ape;
    window.close()
}
</script> 
