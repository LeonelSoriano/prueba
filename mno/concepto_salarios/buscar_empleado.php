...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        <?php
        include("../../db.php");
        $sql ="SELECT * FROM mrh_empleado ORDER BY mrh_empleado.cedula * 1";
        ...
        while($test = mysql_fetch_array($result))
        {
            ...
            echo"<td style='text-align: left'><font color='black'>". $cedula .  "</font></td>";
            echo"<td style='text-align: left'><font color='black'>". $nombre_entero . "</font></td>";
            echo"<td style='text-align: left' ><font color='black'>". $celular . "</font></td>";
            echo"<td style='text-align: left'><font color='black'>". $sexo .  "</font></td>";
            echo '<td> <ul onClick="devolvercedula(\''.$id.'\',\''.$cedula.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
...
<script>
    function devolvercedula(id,cedula){

        opener.document.formulario.cedula.value = cedula;
        opener.document.formulario.codigo_empleado_hi.value = id;
        opener.document.formulario.cedula_hi.value = cedula;
