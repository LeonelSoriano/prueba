...
$anhio = $_POST['anhio'];
$mes = $_POST['mes'];
$sueldo_mensual = str_replace(',','.',$_POST['sueldo_mensual']);
$beca_trabajador = str_replace(',','.',$_POST['beca_trabajador']);
$beca_hijo = str_replace(',','.',$_POST['beca_hijo']);
$asistencia_medica_input = str_replace(',','.',$_POST['asistencia_medica_input']);
$venta_totales = str_replace(',','.',$_POST['venta_totales']);
$venta_acredito = str_replace(',','.',$_POST['venta_acredito']);
$venta_colectivo = str_replace(',','.',$_POST['venta_colectivo']);
...
$exta_diurna_semana[0] = str_replace(',','.',$_POST['exta_diurna_semana1']);
$exta_diurna_semana[1] = str_replace(',','.',$_POST['exta_diurna_semana2']);
$exta_diurna_semana[2] = str_replace(',','.',$_POST['exta_diurna_semana3']);
$exta_diurna_semana[3] = str_replace(',','.',$_POST['exta_diurna_semana4']);

$exta_nocturna_semana[0] = str_replace(',','.',$_POST['exta_nocturna_semana1']);
$exta_nocturna_semana[1] = str_replace(',','.',$_POST['exta_nocturna_semana2']);
$exta_nocturna_semana[2] = str_replace(',','.',$_POST['exta_nocturna_semana3']);
$exta_nocturna_semana[3] = str_replace(',','.',$_POST['exta_nocturna_semana4']);

$cestastiket_semana[0] = str_replace(',','.',$_POST['cestastiket1']);
$cestastiket_semana[1] = str_replace(',','.',$_POST['cestastiket2']);
$cestastiket_semana[2] = str_replace(',','.',$_POST['cestastiket3']);
$cestastiket_semana[3] = str_replace(',','.',$_POST['cestastiket4']);


if(isset($_POST['hora_extra_diurna5'])){
    $exta_diurna_semana[4] = str_replace(',','.',$_POST['exta_diurna_semana5']);
}

if(isset($_POST['exta_nocturna_semana5'])){
    $exta_nocturna_semana[4] = str_replace(',','.',$_POST['exta_nocturna_semana5']);
}

if(isset($_POST['cestastiket5'])){
    $cestastiket_semana[4] = str_replace(',','.',$_POST['cestastiket5']);
}

//$cesta_ticket = $_POST['cesta_ticket'];


$dias_feriado = $_POST['dias_feriado'];



$dias_feriado_trabajado1 = $_POST['dias_feriado_trabajado1'];
$dias_feriado_trabajado2 = $_POST['dias_feriado_trabajado2'];
$dias_feriado_trabajado3 = $_POST['dias_feriado_trabajado3'];
$dias_feriado_trabajado4 = $_POST['dias_feriado_trabajado4'];

$dias_feriado_trabajado5 = 0;

if(isset($_POST['dias_feriado_trabajado5'])){
    $dias_feriado_trabajado5 = $_POST['dias_feriado_trabajado5'];
}
...
if(isset($_POST['bono_responsabilidad'])){
...
if(isset($_POST['bono_productividad'])){
...
if(isset($_POST['bono_eficiencia'])){
...
if(isset($_POST['bono_profesionalizacion'])){

    $bono_profesionalizacion = $_POST['bono_profesionalizacion'];
...
/** Salario normal */
$salario_normal = $sueldo_costo + $bono_antiguedad + $bono_anhio_servicios + $bono_eficiencia + $bono_productividad + $bono_profesionalizacion + $bono_responsabilidad + $bono_variable_costo + $monto_fijo;
...
if(isset($_POST['prima_matrimonio'])){
...
if(isset($_POST['prima_nacimiento'])){
...
$compenzatorio = ($salario_normal + $COMICIONES + $pago_unidades + $sum_bono_producido)/$numero_lunes * 2 - $sueldo_costo / 7 * 2;
...
$caja_semanal = $sueldo  * $CAJA_DE_AHORRO / 100;
$caja_total = $caja_semanal * $numero_lunes;
if($numero_lunes == 5){
...
/* post vacacional */
    ...
    $prestaciones_sociales_semana = $salario_integral / 7 *  $PRESTACIONES_SOCIALES / $numero_lunes;

    $prestaciones_sociales_total = $prestaciones_sociales_semana * $numero_lunes;
    ...
    $beca_hijo_semana = ($beca_hijo ) / $numero_lunes;

    $beca_hijo_total = $beca_hijo_semana * $numero_lunes;
    ...
    if(isset($_POST['asistencia_medica_check'])){
    ...
    $juguete_semana = $juguete_valor;

    $juguete_total = $juguete_semana * $numero_lunes;
...
$result=mysql_query($sql);
    ...
    if($total_hijos_empresa != 0){
        $dia_ninho_semana = ($dia_ninho / 52)/  $total_hijos_empresa;
    }

    $dia_ninho_semana5 = 0;

    $dia_ninho_total = $dia_ninho_semana  * $numero_lunes;
    ...
    $fiesta_anhio_trabajador_semana = ($fiesta_anhio_trabajador / 52)/  $NUMERO_EMPLEADOS;

    $fiesta_anhio_trabajador_semana5 = 0;

    $fiesta_anhio_trabajador_total = $fiesta_anhio_trabajador_semana  * $numero_lunes;
