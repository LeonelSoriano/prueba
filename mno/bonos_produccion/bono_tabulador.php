...
if(isset($_POST['submit'])){
    ...
    if(!$validated->getIsError()){
        ...
        $sql = "INSERT INTO  mco_tabulador_nuevo_bonos_produccion(paso,valor,referencia) VALUES
        ('$paso','$valor','$hasta')";

        mysql_query($sql) or die('error agregar tabulador_nuevos bonos'.mysql_error());
...
$codigo_get = 0;
if(isset($_GET['codigo_bono_hi'])){

    $codigo_get = $_GET['codigo_bono_hi'];
...
//                                }
                                ...
                                $sql = "SELECT * FROM mco_tabulador_nuevo_bonos_produccion ORDER BY paso";
