...
function devolvercedula(ced,nom,ape){
   /*      alert(ced);
    ...
    opener.document.copiar_concepto_empleados.cedulaempleadodestino.value = ced;
    opener.document.copiar_concepto_empleados.nombredestino.value = nom;
    opener.document.copiar_concepto_empleados.apellidodestino.value = ape;
    window.close()
}
</script> 
