...
<form method="post" name="copiar_concepto_empleados">
    <div id="body_bottom_bgd">
        <div id=""> <!--<img src="images/Logo_Inventario.png"/>-->
          <!--</div>-->                <!-- Menu -->
                  <!--  ?php include 'include/nav.php'; ?>-->
...
<TABLE BORDER="0" CELLSPACING="4" WIDTH="500">
    ...
    <TR>
        <TD width="173"><label>Cédula de Empleado Origen</label></TD>
        <TD width="94">
    ...
    <TR>
     ...
     <TR>
        <TD width="173"><label>Cédula de Empleado Destino</label></TD>
        <TD width="94">
            <input type="text" name="cedulaempleadodestino" id="cedulaempleadodestino" size="20"  value=<?php echo $cedulaempleadodestino ?>></TD>
        <TD>
            <!--<input type="submit" value="Buscar" name="submit">-->
            <input type="button" onClick="javascript: buscar_empleado_destino()" name="buscardestino" value="Buscar" >
        </TD>
    </TR> 
    <TR>
        <TD><label>Nombre</label></TD>
        <TD><input type="text" name="nombredestino" id="nombredestino" size="20" disabled value=<?php echo strtoupper($nombredestino) ?>></TD>
        <TD width="107"><label>Apellido</label></TD>
        <TD width="98"><input type="text" name="apellidodestino" id="apellidodestino" size="20" disabled value=<?php echo strtoupper($apellidodestino) ?>></TD>
    </TR>
...
<TR>
    ...
    <TD>
        ...
        <a><input type="Submit" name="submit" value="Copiar Conceptos"></a> 
    </TD>    
    <TD>
...
function buscar_empleado(){
    win = window.open("copiar_concepto_empleados_buscarempleado.php", "nuevo", "directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=400, height=400");
    win.focus(); 
}
function buscar_empleado_destino(){
    win = window.open("copiar_concepto_empleados_buscarempleado_destino.php", "nuevo", "directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=400, height=400");
    win.focus(); 
}
