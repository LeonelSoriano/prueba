...
function devolvercedula(ced,nom,ape){
    ...
    opener.document.concepto_empleados.cedulaempleado.value = ced;
    opener.document.concepto_empleados.nombre.value = nom;
    opener.document.concepto_empleados.apellido.value = ape;
    window.close()
}
</script> 
