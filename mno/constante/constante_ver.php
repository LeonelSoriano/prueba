...
<table border=1>
    ...
    <?php
	include("../../db.php");
	$result=mysql_query("SELECT * FROM mno_constante");
        while($test = mysql_fetch_array($result))
        	{
                //  calculos de horas
                    ...
                    echo"<td> <a href ='constante_mod.php?codigo=$id'>Modificar</a>";
                    echo"<td> <a href ='constante_del.php?codigo=$id'><center>Borrar</center></a>";
                    echo "</tr>";
		}
	mysql_close($conn);
    ?>
</table> 
<a href="constante.php"><input type="button" value="Atras"></a> 
<p></p>
                                </div>
                            </div><!--end firefoxbug-->
                        </div><!--end left_bgd-->
