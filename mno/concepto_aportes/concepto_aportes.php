...
<!-- Beginning of compulsory code below -->
 ...
 <h1><img src="/sicap/images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Nómina | Conceptos de Aportes</strong></h1>
...
function buscar_empleado(){
    win = window.open("concepto_salarios_buscarempleado.php", "nuevo", "directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=400, height=400");
    win.focus(); 
}
