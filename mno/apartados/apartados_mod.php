...
<form method="post">
   <div id="body_bottom_bgd">
    ...
    <h1><img src="/sicap/images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Recursos Humanos | Cargo</strong></h1>
...
<table>
    <tr>    
        ...
        <td><a href="apartados_ver.php"><input type="button" value="Atras"></a></td> 
    </tr>
</table>
<!-- / END -->
<p></p>
