...
<form method="post">
    ...
    <table border=none class="tablas-nuevas">
        ...
        while($test = mysql_fetch_array($result))
        {
            //  calculos de horas
            $id = $test['codigo'];
            $codigo_unidad = $test['codigoalias'];
            $nombre = $test['descripcion'];


            echo "<tr align='center'>";
            echo"<td><font color='black'>" .$codigo_unidad."</font></td>";
            echo"<td><font color='black'>". $nombre . "</font></td>";

            echo '<td> <ul onClick="devolvercedula(\''.$nombre .'\',\''.$id.'\')" id="icons" class="ui-widget ui-helper-clearfix"> <li class="ui-state-default ui-corner-all" title=".ui-icon-check"><span class="ui-icon ui-icon-check"></span></li> </ul></td>';
...
<script>
    function devolvercedula(codigo_alias,id){


        opener.document.gerencia.dependiente.value =  codigo_alias ;
        opener.document.gerencia.dependiente_nombre_hi.value =  codigo_alias ;
        opener.document.gerencia.dependiente_hi.value = id;
