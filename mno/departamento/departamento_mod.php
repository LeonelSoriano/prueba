...
$result = mysql_query("SELECT * FROM mno_departamento WHERE codigounidad  = '$unidad' and codigogerencia='$gerencia' and codigo='$departamento'");
//echo $result;
//exit;
$test = mysql_fetch_array($result);
if (!$result) 
...
{	
        ...
        $sql = "update mno_departamento set codigoalias='$codigoalias',descripcion='$descripcion'
                 where codigogerencia = '$gerencia' and codigounidad='$unidad' and codigo='$departamento'";
       //echo $sql;
       //exit;
	mysql_query($sql)
...
<tr>
    ...
    <td><a href="departamento_ver.php?gerencia=<?php echo $gerencia?>&unidad=<?php echo $unidad?>"><input type="button" value="Atras"></a><td>
</tr>
</table>
<!-- / END -->
