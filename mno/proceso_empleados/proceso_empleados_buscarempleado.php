...
function devolvercedula(ced,nom,ape){
    ...
    opener.document.proceso_empleados.cedulaempleado.value = ced;
    opener.document.proceso_empleados.nombre.value = nom;
    opener.document.proceso_empleados.apellido.value = ape;
    window.close()
}
</script> 
