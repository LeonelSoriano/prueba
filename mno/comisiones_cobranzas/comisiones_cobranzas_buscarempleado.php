...
function devolvercedula(ced,nom,ape){
    ...
    opener.document.comisiones_cobranzas.cedulaempleado.value = ced;
    opener.document.comisiones_cobranzas.nombre.value = nom;
    opener.document.comisiones_cobranzas.apellido.value = ape;
    window.close()
}
</script> 
