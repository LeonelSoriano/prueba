...
<!-- Beginning of compulsory code below -->
 ...
 <h1><img src="/sicap/images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Nómina | Beneficios de Hijos</strong></h1>
...
<TABLE BORDER="0" CELLSPACING="4" WIDTH="500">
    ...
    <TR>
        ...
        // Consultar la base de datos
                ...
                echo "<TD>";
                echo "<select name='codigohijo' id='codigohijo' >";
        ...
        ?>  
        <td>
			    <a><input type="Submit" name="extraer" value="Cargar Hijos"></a> 
		</td>	
    </TR>
    <TR>
...
function buscar_empleado(){
    win = window.open("beneficio_hijos_buscarempleado.php", "nuevo", "directories=no, location=no, menubar=no, scrollbars=yes, statusbar=no, tittlebar=no, width=400, height=400");
    win.focus(); 
}
