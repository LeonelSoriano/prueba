...
<table border=1>
    ...
    <?php
	include("../../db.php");
	$result=mysql_query("SELECT * FROM mno_concepto order by codigoproceso");
        while($test = mysql_fetch_array($result))
        	{
                //  calculos de horas
                    ...
                    echo"<td> <a href ='concepto_mod.php?codigo=$id'>Modificar</a>";
                    echo"<td> <a href ='concepto_del.php?codigo=$id'><center>Borrar</center></a>";
                    echo "</tr>";
		}
	mysql_close($conn);
    ?>
</table> 
<a href="concepto.php"><input type="button" value="Atras"></a> 
<p></p>
                                </div>
                            </div><!--end firefoxbug-->
                        </div><!--end left_bgd-->
