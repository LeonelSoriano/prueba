...
$result = mysql_query("SELECT * FROM mno_concepto WHERE codigo  = '$id'");
//echo $result;
//exit;
...
{	
        ...
        $sql = "update mno_concepto set codigoproceso='$codigoproceso',descripcion='$descripcion',asignacion='$asignacion'
                 where codigo = '$id'";
       //echo $sql;
       //exit;
...
<form method="post">
   <div id="body_bottom_bgd">
    ...
    <h1><img src="/sicap/images/seleccion_sicap_archivos/image002.jpg" alt="flickr" /><strong>                Módulo de Recursos Humanos | Concepto</strong></h1>
...
<table>
    <tr>    
        ...
        <td><a href="concepto_ver.php"><input type="button" value="Atras"></a></td> 
    </tr>
</table>
<!-- / END -->
<p></p>
