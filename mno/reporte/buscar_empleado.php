...
";
            ...
            echo"<td style='text-align: left' ><font color='black'> * </font></td>";
            ...
            while($test = mysql_fetch_array($result))
            {
                ...
                echo"<td style='text-align: left'><font color='black'  >". $primerapellido ."  ". $primernombre . "</font></td>";
    ...
    <script>
        function devolver(id,cedula){
            ...
            opener.document.formulario.cedulaempleado.value = id;
