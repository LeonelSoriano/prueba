...
function buscar_empleado(){
    win = window.open("concepto_empleados_buscarempleado.php", "nuevo", "directories=no, location=no, menubar=no, scrollbars=no, statusbar=no, tittlebar=no, width=400, height=400");
    win.focus(); 
}
