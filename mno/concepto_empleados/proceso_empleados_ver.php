        ...
        while($test = mysql_fetch_array($result))
        	{
                //  calculos de horas
                    ...
                    echo"<td><font color='black'>" .$test['codigogerencia']."</font></td>";
                    echo"<td><font color='black'>". $test['codigounidadadm']."</font></td>";
                    echo"<td><font color='black'>". $test['codigodepartamento']."</font></td>";
