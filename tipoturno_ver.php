        ...
        while($test = mysql_fetch_array($result))
        	{
                //  calculos de horas
                    ...
                    echo"<td><font color='black'>". $test['horasemanales']."</font></td>";
                    echo"<td> <a href ='tipoturno_mod.php?codigo=$id'>Modificar</a>";
                    echo"<td> <a href ='tipoturno_del.php?codigo=$id'><center>Borrar</center></a>";
                    echo "</tr>";
		}
	mysql_close($conn);
    ?>
