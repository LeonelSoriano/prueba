...
<table border=1>
    ...
    <?php
	include("db.php");
	$result=mysql_query("SELECT * FROM mno_aporte");
        while($test = mysql_fetch_array($result))
        	{
                //  calculos de horas
                    ...
                    echo"<td> <a href ='aporte_mod.php?codigo=$id'>Modificar</a>";
                    echo"<td> <a href ='aporte_del.php?codigo=$id'><center>Borrar</center></a>";
                    echo "</tr>";
		}
	mysql_close($conn);
    ?>
...
<table>    
    <tr>
        <a href="aporte.php"><input type="button" value="Atras"></a>
    </tr> 
</table>
<p></p>
                                </div>
