        ...
        while($test = mysql_fetch_array($result))
        	{
                //  calculos de horas
                    ...
                    echo"<td><font color='black'>". utf8_multiplataforma($test['codigo']). "</font></td>";
                    echo"<td><font color='black'>" .utf8_multiplataforma($test['codigoalias'])."</font></td>";
                    echo"<td><font color='black'>". utf8_multiplataforma($test['descripcion'])."</font></td>";
