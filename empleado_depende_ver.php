...
<form method="get" accept-charset="UTF-8" name="formulario" action="empleado_dependientes_ver.php">
                ...
                <div id="">
                    <div id="firefoxbug"><!-- firefoxbug -->
                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <table>
                                <tr>
                                    <td><input type="submit" value="Ver dependientes" ></td>
                                    <td><a href="./dependiente.php"><input type="button" value="Atras"></a> </td>
